...
erc20_6551 = w3.eth.contract(address='0x0000000000000000000000000000000000000005', abi=erc20_6551_abi)
erc721_did = w3.eth.contract(address='0x0000000000000000000000000000000000000006', abi=erc721_did_abi)
...
for action in sys.argv[1:]:
    ...
    elif action == 'init6551':
        unsigned_tx = erc20_6551.functions.init('USD2', 'U2', 18, '0x0000000000000000000000000000000000000000').build_transaction({
            'from': account.address,
            'nonce': nonce,
        })
        # print(unsigned_tx)
